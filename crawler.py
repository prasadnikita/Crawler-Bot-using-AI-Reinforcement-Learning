...
def runReward(self, new_angle1, new_angle2):
    # Calculate the reward based on the new angle1 and angle2 values
    # You can use the current state of the crawler, such as contact, location, etc.
    # to determine the reward

    # For example, you can use a simple reward function like:
    reward = 0
    if self.contact:
        reward = -1
    else:
